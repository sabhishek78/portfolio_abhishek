            ...
            <div className='main'>
                <div className="header" style={{ opacity: `${this.state.opacity}`}} >
                    <div className="nameAndPicture">
                        ...
                        <img  src={require('../profilepic.jpg')} style={{width: 80, height: 80, borderRadius: 40,margin:10}} />
                    </div>
                    <div className="menu">
                ...
                <div id='whatIDo'>
                    <div>
                        ...
                        <div>
                            <img className='skillsImage' src={require('../webdevelopment.jpg')} />
                        ...
                        <div>
                            <img className='skillsImage' src={require('../mobileappdevelopment.png')} />
                        ...
                        <div>
                            <img className='skillsImage' src={require('../databasedevelopment.jpg')} />
                        ...
                        <div>
                            <img className='skillsImage' src={require('../cloudintegration.png')} />
                    ...
                    <div id='portfolio'>
                        ...
                        <div>
                            ...
                            <a href="https://github.com/sabhishek78/tic_tac_toe_starter" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='flutterImage' src={require('../tictactoe1.png')} />
                            <img className='flutterImage' src={require('../tictactoe2.png')} />
                            <img className='flutterImage' src={require('../tictactoe3.png')} />
                            <img className='flutterImage' src={require('../tictactoe4.png')} />
                        ...
                        <div>
                            ...
                            <img className='flutterImage' src={require('../mcTimes1.png')} />
                            <img className='flutterImage' src={require('../mcTimes2.png')} />
                            <img className='flutterImage' src={require('../mcTimes3.png')} />
                            <img className='flutterImage' src={require('../mcTimes4.png')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Movie Carousel App</p>
                            <a href="https://github.com/sabhishek78/day_4_movies_assignment" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='flutterImage' src={require('../carousel1.png')} />
                            <img className='flutterImage' src={require('../carousel2.png')} />
                            <img className='flutterImage' src={require('../carousel3.png')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Currency Exchange App</p>
                            <a href="https://github.com/sabhishek78/currency_exchange_app" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            <p style={{ color:'gray',fontSize:20,fontWeight:'bold' }}>A Currency Converter App based on Open Rates api</p>
                            <img className='flutterImage' src={require('../ce1.png')} />
                            <img className='flutterImage' src={require('../ce2.png')} />
                            <img className='flutterImage' src={require('../ce3.png')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Animal Guess Game App</p>
                            <a href="https://github.com/sabhishek78/animal_game_botchat" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='flutterImage' src={require('../agg1.png')} />
                            <img className='flutterImage' src={require('../agg2.png')} />
                            <img className='flutterImage' src={require('../agg3.png')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Climate App</p>
                            <a href="https://github.com/sabhishek78/climate_appnew" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='flutterImage' src={require('../climate1.png')} />
                            <img className='flutterImage' src={require('../climate2.png')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Spotify App</p>
                            <a href="https://github.com/sabhishek78/spotify_player_clone" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='flutterImage' src={require('../spotify1.png')} />
                            <img className='flutterImage' src={require('../spotify2.png')} />
                            <img className='flutterImage' src={require('../spotify3.png')} />
                            <img className='flutterImage' src={require('../spotify4.png')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Quotes App</p>
                            <a href="https://github.com/sabhishek78/my_quotes_app" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='flutterImage' src={require('../quotes1.png')} />
                            <img className='flutterImage' src={require('../quotes2.png')} />
                            <img className='flutterImage' src={require('../quotes3.png')} />
                            <img className='flutterImage' src={require('../quotes4.png')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Movies App</p>
                            <a href="https://github.com/sabhishek78/movie_web_page_layout" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            <p style={{ color:'gray',fontSize:20,fontWeight:'bold' }}>A Movies Desktop App based on'themoviesdb' api. The user
                            can search for a particular movie title.The user can click on a particular movie to view the movie details.</p>
                            <img className='desktopImage' src={require('../movies1.jpg')} />
                            <img className='desktopImage' src={require('../movies1.jpg')} />
                            <img className='desktopImage' src={require('../movies1.jpg')} />
                        ...
                        <div>
                            ...
                            <img className='desktopImage' src={require('../hackerTimesDesktop1.jpg')} />
                            <img className='desktopImage' src={require('../hackerTimesDesktop2.jpg')} />
                            <img className='desktopImage' src={require('../hackerTimesDesktop3.jpg')} />
                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Desktop Quiz App</p>
                            <a href="https://github.com/sabhishek78/quiz_webapp_starter" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='desktopImage' src={require('../quiz1.jpg')} />
                            <img className='desktopImage' src={require('../quiz3.jpg')} />
                            <img className='desktopImage' src={require('../quiz4.jpg')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Mark Down Editor</p>
                            <a href="https://github.com/sabhishek78/mark_down_editor" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='desktopImage' src={require('../markdown.jpg')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Count Down Timer</p>
                            <a href="https://github.com/sabhishek78/count_down_timer" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='desktopImage' src={require('../timer.jpg')} />

                        </div>
                        <div>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>CRM App</p>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Frontend</p>
                            <a href="https://github.com/sabhishek78/react_form" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            <p style={{ color:'black',fontSize:30,fontWeight:'bold' }}>Backend</p>
                            <a href="https://github.com/sabhishek78/customer_backend" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2}} /></a>
                            ...
                            <img className='desktopImage' src={require('../crm1.jpg')} />
                            <img className='desktopImage' src={require('../crm2.jpg')} />
                            <img className='desktopImage' src={require('../crm3.jpg')} />
                    ...
                    <div>
                        <div id='about'>
                            ...
                            <img  src={require('../profilepic.jpg')} style={{width: 400, height: 400, borderRadius: 400/ 2}} />
                            <p style={{ color:'gray',fontSize:30 }}>ReactJS | Flutter | Node JS</p>
                            <a href="https://github.com/sabhishek78" target="_blank"><img  src={require('../githubIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2,margin:20}} /></a>
                            <a href="https://www.facebook.com/abhishekshrivastava78" target="_blank"><img  src={require('../facebookIcon.webp')} style={{width: 50, height: 50, borderRadius: 50/ 2,margin:20}} /></a>
                            <a href="https://www.linkedin.com/in/sabhishek78" target="_blank"><img  src={require('../linkedinIcon.png')} style={{width: 50, height: 50, borderRadius: 50/ 2,margin:20}} /></a>
                            ...
                            <img  src={require('../jsLogo.jpg')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../flutter.png')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../dart.png')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../reactLogo.png')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../htmlLogo.png')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../cssLogo.png')} style={{width: 100, height: 100,margin:5}} />
                            <p style={{ color:'black',fontSize:40,fontWeight:'bold' }}>BACKEND</p>
                            <img  src={require('../npm-226037.png')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../nodejs.png')} style={{width: 100, height: 100,margin:5}} />

                            <p style={{ color:'black',fontSize:40,fontWeight:'bold' }}>DATABASES</p>
                            <img  src={require('../firebaseLogo.png')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../mongodb.webp')} style={{width: 100, height: 100,margin:5}} />
                            <img  src={require('../aws_logo.png')} style={{width: 100, height: 100,margin:5}} />
                        </div>
                    </div>
                </div>
                    <div id='contact' style={{ backgroundImage: `url(${require("../world.jpg")})` }}>
                        ...
                        <div className="whatsapp">
                            <a href="https://wa.me/919713219321" target="_blank"><img  src={require('../whatsapp.webp')} style={{width: 50, height: 50, borderRadius: 50/ 2}}/></a>
